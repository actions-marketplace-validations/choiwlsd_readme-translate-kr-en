...
The current Marketplace release is [`v0.2.1`](https://github.com/choiwlsd/readme-translate-kr-en/releases/tag/v0.2.1). Pinning the full release tag gives reproducible behavior:
